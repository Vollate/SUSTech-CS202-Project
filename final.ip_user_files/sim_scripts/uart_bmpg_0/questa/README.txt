...
#
# Generated by export_simulation on Thu May 18 17:35:43 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './uart_bmpg_0.sh' script.

./uart_bmpg_0.sh -reset_run
...
./uart_bmpg_0.sh -noclean_files

For more information on the script, please type './uart_bmpg_0.sh -help'.
